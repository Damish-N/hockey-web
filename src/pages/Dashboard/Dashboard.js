...
function Dashboard(props) {
    const columns = [
        ...
        {
            id: 'attend', label: 'Attend', minWidth: 170, buttons: [
                {id: 'yes', label: 'Yes'},
                {id: 'no', label: 'No'},
    ...
    return (
        <div className={Styles.dashboardContainer}>
            <Grid xs={12} className={Styles.item} container direction={"row"} justifyContent={"space-around"} spacing={2}>
                <Grid className={Styles.itemContainer} xs={10} md={4}>
                    <Paper className={Styles.item_paper}>
                        <div className={Styles.item_paper_Container}>
                            <AccessibilityNewIcon style={{fontSize: '2.85rem'}} className={Styles.iconDetails}>
                ...
                <Grid className={Styles.itemContainer} xs={10} md={4}>
                    <Paper className={Styles.item_paper}>
                        <div className={Styles.item_paper_Container}>
                            <MonetizationOnIcon style={{fontSize: '2.85rem'}}
                                                className={Styles.iconDetails}></MonetizationOnIcon>
                            <div className={Styles.item_paper_Container_Secondry}>
                                <Typography variant={"h5"} className={Styles.textColor}>
                                    25,650
                                </Typography>
